export default {
  ...
  notice: {
    retryTitle: 'Request Timeout',
    retryMessage: 'Retrying to connect to server...',
    operationStart: 'Operation in Progress',
    operationSuccess: 'Operation Successful',
    operationError: 'Operation Failed',
    loginStart: 'Logging in...',
    loginSuccess: 'Login successful',
    loginError: 'Login failed',
    passwordUpdateStart: 'Updating password...',
    passwordUpdateSuccess: 'Password updated successfully',
    passwordUpdateError: 'Password update failed',
    accountCreateStart: 'Creating account...',
    accountCreateSuccess: 'Account created successfully',
    accountCreateError: 'Account creation failed',
    accountUpdateStart: 'Updating account...',
    accountUpdateSuccess: 'Account updated successfully',
    accountUpdateError: 'Account update failed',
    accountDeleteStart: 'Deleting account...',
    accountDeleteSuccess: 'Account deleted successfully',
    accountDeleteError: 'Account deletion failed',
    serverCreateStart: 'Creating server...',
    serverCreateSuccess: 'Server created successfully',
    serverCreateError: 'Server creation failed',
    serverUpdateStart: 'Updating server...',
    serverUpdateSuccess: 'Server updated successfully',
    serverUpdateError: 'Server update failed',
    serverDeleteStart: 'Deleting server...',
    serverDeleteSuccess: 'Server deleted successfully',
    serverDeleteError: 'Server deletion failed',
    nodeCreateStart: 'Creating node...',
    nodeCreateSuccess: 'Node created successfully',
    nodeCreateError: 'Node creation failed',
    nodeUpdateStart: 'Updating node...',
    nodeUpdateSuccess: 'Node updated successfully',
    nodeUpdateError: 'Node update failed',
    nodeDeleteStart: 'Deleting node...',
    nodeDeleteSuccess: 'Node deleted successfully',
    nodeDeleteError: 'Node deletion failed'
  },
  confirm: {
