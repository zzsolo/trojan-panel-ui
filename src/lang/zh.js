export default {
  ...
  notice: {
    retryTitle: '请求超时',
    retryMessage: '正在重新尝试连接服务器...',
    operationStart: '操作进行中',
    operationSuccess: '操作成功',
    operationError: '操作失败',
    loginStart: '正在登录...',
    loginSuccess: '登录成功',
    loginError: '登录失败',
    passwordUpdateStart: '正在修改密码...',
    passwordUpdateSuccess: '密码修改成功',
    passwordUpdateError: '密码修改失败',
    accountCreateStart: '正在创建账户...',
    accountCreateSuccess: '账户创建成功',
    accountCreateError: '账户创建失败',
    accountUpdateStart: '正在更新账户...',
    accountUpdateSuccess: '账户更新成功',
    accountUpdateError: '账户更新失败',
    accountDeleteStart: '正在删除账户...',
    accountDeleteSuccess: '账户删除成功',
    accountDeleteError: '账户删除失败',
    serverCreateStart: '正在创建服务器...',
    serverCreateSuccess: '服务器创建成功',
    serverCreateError: '服务器创建失败',
    serverUpdateStart: '正在更新服务器...',
    serverUpdateSuccess: '服务器更新成功',
    serverUpdateError: '服务器更新失败',
    serverDeleteStart: '正在删除服务器...',
    serverDeleteSuccess: '服务器删除成功',
    serverDeleteError: '服务器删除失败',
    nodeCreateStart: '正在创建节点...',
    nodeCreateSuccess: '节点创建成功',
    nodeCreateError: '节点创建失败',
    nodeUpdateStart: '正在更新节点...',
    nodeUpdateSuccess: '节点更新成功',
    nodeUpdateError: '节点更新失败',
    nodeDeleteStart: '正在删除节点...',
